...
import { CreateOrderInput, CreateOrderItemInput, UpdateOrderItemStatusInput } from '../types/orders.js';
...
router.put('/items/:id/status', authMiddleware, (req: Request, res: Response) => {
  try {
